        ...
        <div class="row">
            <div class="benefits">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 images">
                    <div class="image1"><img src="<?php echo e(URL::to('images/m_benefits.jpg')); ?>" alt="benefit"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="benefits">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 images">
                    <div class="image1"><img src="<?php echo e(URL::to('images/v_benefits.jpg')); ?>" alt="benefit"></div>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.body',['headerClass'=>'events-hero','active'=>'benefits','script'=>'benefits'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>