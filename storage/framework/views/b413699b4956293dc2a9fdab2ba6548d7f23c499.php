...
<form action="<?php echo e(route('course.update',$course->id)); ?>" id="event-form" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input class="form-control" type="text" name="code" id='code' value="<?php echo e($course->hours); ?>" placeholder="A">
	</div>

	<div class="form-group">
		<label class="control-label" for="year">Year : </label>
		<input class="form-control" type="number" name="year" id='year' value="<?php echo e($course->year); ?>" placeholder="year">
	</div>

	<div class="form-group">
		<label class="control-label" for="code">Code : </label>
		<input class="form-control" type="text" name="code" id='code' value="<?php echo e($course->code); ?>" placeholder="AA">
	</div>
