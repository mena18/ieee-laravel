...
<form action="<?php echo e(route('magazine.store')); ?>" id="event-form" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input class="form-control" type="text" name="url" id='url' value="<?php echo e(old('url')); ?>" placeholder="URL">
	</div>
