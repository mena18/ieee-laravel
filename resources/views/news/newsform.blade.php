<form action="{{route($route,$options)}}" id="news-form" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="date" placeholder="MM/DD/YYYY" value="{{$news->date?\Carbon\Carbon::createFromTimeString($news->date)->format("d/m/Y"):''}}">
	</div>
	<div class="form-group">
