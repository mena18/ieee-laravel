@extends('layout.body', ['headerClass'=>'hero-3', 'active'=>'home','script'=>['home']])
...
{{--Home only--}}
    <div class="hero-img col-sm-5 col-md-5">
        <img src="{{URL::to('images/ieeepuasb-back-tshirt.png')}}" alt="image">
    </div>
@endsection
...
@section('content')
    ...
    @if($mega!==null)
        <section class="megaEvent">
            <img src="{{URL::to('images/events/b4cade14b9e79598869833bfcdaaf4682446fd23.jpg')}}" alt="Mega Event">
            <a href="{{route('mega.event',['id'=>$mega->id])}}" class="btn btn-success btn-lg col-xs-12 megaBtn">Read More &amp; Register</a>
        </section>
    @endif
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="section-content">
                    ...
                    <div class="col-sm-3">
                        <h3 class="home-count">{{$event_number}}</h3>
                        <p>Event</p>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        <h3 class="home-count">{{$volunteers_number}}</h3>
                        <p>Volunteer</p>
                    </div>
                </div>
            </div>
    ...
    @include('inc.fiveimages',['gallery'=>$gallery])
