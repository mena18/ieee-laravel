...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{URL::to('design/adminlte')}}/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{URL::to('design/adminlte')}}/index2.html">IEEE<b>PUASB</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    @if(count($errors)>0)
      ...
      @include('inc.errors',['errors'=>$errors])
    @endif
