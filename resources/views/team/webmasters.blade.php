@extends('layout.body',['headerClass'=>'news-hero','active'=>'webmasters'])
@section('title')
Web Masters
@endsection
@section('caption')
	...
	<div class="container">
		<div class="rowvolunteer">
			...
			<div class="col-xs-offset-3 col-xs-6 col-sm-offset-4 col-md-offset-4 col-md-3 col-lg-offset-4 col-lg-3 volunteers head wow animated bounceInLeft">
				<img class="imageOfVolunteer" src="{{URL::to('images/webMasters/amr.jpg')}}" alt="Amr head of web development" title="Amr Ahmed">
				<h2>Amr Ahmed</h2>
		...
		<div class="rowvolunteer">
			...
			<div class="col-xs-6 col-md-3 col-lg-3 volunteers webMas webMem wow animated fadeInDownBig">
				<img class="imageOfVolunteer" src="{{URL::to('images/webMasters/omar.jpg')}}" alt="Omar vice head of web development" title="Omar Ehab">
				<h2>Omar Ehab</h2>
			...
			<div class="col-xs-6 col-md-3 col-lg-3 volunteers webMem wow animated fadeInDownBig">
				<img class="imageOfVolunteer" src="{{URL::to('images/webMasters/radwa.jpg')}}" alt="radwa volunteer in web development committee" title="Radwa Saad">
				<h2>Radwa Saad</h2>
			...
			<div class="col-xs-6 col-md-3 col-lg-3 volunteers webMem wow animated fadeInDownBig">
				<img class="imageOfVolunteer" src="{{URL::to("images/volunteers/c370ea41292e48207a5ecb05f5fe7087f55e8632.jpg")}}" alt="Mena volunteer in web development committee" title="Mena Naeem">
				<h2>Mena Naeem</h2>
				<p>Volunteer in Web development committee</p>
			...
			<div class="col-xs-6 col-md-3 col-lg-3 volunteers webMem wow animated fadeInDownBig">
				<img class="imageOfVolunteer" src="{{URL::to('images/webMasters/magdy.jpg')}}" alt="ahmed  volunteer in web development committee" title="Ahmed Magdy">
				<h2>Ahmed Magdy</h2>
				<p>Volunteer in Web Development Committee</p>
