...
class CertificatesDB extends Seeder
{
    ...
    public function run()
    {
        ...
        [110, 'Fatema Mohamed', 20, 'E381-878', 'moharamfatema@gmail.com', 8, ''],
        [111, 'Farah AbdelFattah', 20, 'E007-444', 'faragmourad037@gmail.com', 8, ''],
        [112, 'Ammar yasser ', 20, 'E486-209', 'Ammaralnagar416@gmail.com', 8, ''],
        [113, 'Donia Mohammed', 20, 'A2434-331', 'doniamohamed13@gmail.com', 9, ''],
        [114, 'Zeina Tamer', 20, 'A2000-795', 'zeinatamer1232@gmail.com', 9, ''],
        [115, 'Aly Emmad', 20, 'A2199-786', 'Ali2424emad@gmail.com', 9, ''],
        [116, 'Amr ElSayed', 20, 'A2013-624', 'amrelmassry24@gmail.com', 9, ''],
        [117, 'Saher AbdelFattah', 20, 'A2223-515', 'sahar_ekmakey@gmail.com', 9, ''],
        [118, 'Yara Ahmed', 20, 'A2586-526', 'ayara351@gmail.com', 9, ''],
        [119, 'omar Mohammed', 20, 'A2330-659', 'Merothehero1812@outlook.com', 9, ''],
        [120, 'ahmed yahia', 20, 'A2584-469', 'ayeldreney@gmail.com', 9, ''],
        [121, 'Rewan el nagar', 20, 'A2836-057', '', 9, ''],
        [122, 'omar ahmed ', 20, 'A2644-413', 'order7801@gmail.com', 9, ''],
        [123, 'Mohamed AbdelAziz', 16, 'w052-340', 'Mohameedfarag035@gmail.com', 10, ''],
        [124, 'Mostafa Essam', 16, 'w220-308', 'mostu.yakout@gmail.com', 10, ''],
        [125, 'Donia Mohammed', 16, 'w811-834', 'doniamohamed13@gmail.com', 10, ''],
        [126, 'marwa ahmed', 16, 'w653-481', 'marwa.mamm79@gmail.com', 10, ''],
        [127, 'Mahitor Mohab', 16, 'w051-338', 'mennaemara31@gmail.com', 10, ''],
        [128, 'Mayar Ibrahim', 16, 'w346-502', 'mayaribrahim180@gmail.com', 10, ''],
        [129, 'Henar Ibrahim', 16, 'w728-271', 'henarygaber@gmail.com', 10, ''],
        [130, 'Amira Zakaria', 16, 'w057-516', '', 10, ''],
        [131, 'Rahma magdy', 16, 'w325-283', 'rahma.magdu909@gmail.com', 10, ''],
        [132, 'hassan 3la2', 16, 'w046-838', 'hseenalex24@gmail.com', 10, ''],
        [133, '3adel 3abdah', 16, 'w254-506', 'empty.zero.one.0.1@gmail.com', 10, ''],
        [134, 'Osama abdallah', 16, 'w469-573', 'osamabdallah25@gmail.com', 10, ''],
        [135, 'shimaa ahmed', 16, 'w083-505', 'shimaahmedd@gmai.com', 10, ''],
        [136, 'salma  ibahim', 16, 'w820-599', '', 10, ''],
        [137, 'Ahmed Metwally', 16, 'w903-987', 'ahmedmetwally046@gmail.com', 10, ''],
        [138, 'Hagar Ahmed', 20, 'S014-307', 'Hagaraboukhalil@gmail.com', 11, ''],
        [139, 'assem mahmoud', 20, 'S697-124', 'asem03360@gmail.com', 11, ''],
        [140, 'Sevan hrair', 20, 'S660-334', 'Sevanhrair@gamil.com', 11, ''],
        [141, 'Abdelhaleem Mohammed', 20, 'S857-655', 'haleemelreweny7@gmail.com', 11, ''],
        [142, 'Ahmed Metwally', 20, 'S439-812', 'ahmedmetwally046@gmail.com', 11, ''],
        [143, 'Yasmeen Tariq', 20, 'S415-788', 'yasmeenalsayegh2020@gmail.com', 11, ''],
        [144, 'ragia ', 20, 'D2950-333', '', 12, ''],
        [145, 'shern', 20, 'D2048-259', '', 12, ''],
        [146, 'hager helmi', 20, 'D2982-421', '', 12, ''],
        [147, 'ahmed kamel', 20, 'D2431-174', '', 12, ''],
        [148, 'Omar Sherif', 20, 'G083-492', 'ali22222omar@gmail.com', 13, ''],
        [149, 'Yara El-Sheikh', 20, 'G048-941', 'Yara_elsheikh97@hotmail.com', 13, ''],
        [150, 'Mohamed Elbalahy', 20, 'G180-164', 'mohamedelbalahy58@gmail.com', 13, ''],
        [151, 'Abdallah gharib', 20, 'G680-718', 'Abdallahmgharib@gmail.com', 13, ''],
        [152, 'Ahmed Metwally', 20, 'G979-101', 'ahmedmetwally046@gmail.com', 13, ''],];
	    ...
	    foreach($certificates as $certificate) {
          ...
          $cert->email = $certificate[4];
        	$cert->course_id = $certificate[5];
        	$cert->link = $certificate[6];
        	$cert->save();
	    }
    }
}
